...
- **[.agents/skills/](./.agents/skills/)**: 49 specialized agent skills categorized by domain (`_core`, `android`, `compose/chrisbanes`, `workflow`).
...
## 4. Invariant Checklist (Must Never Violate)
