package pavansaiajayx.aipdfreadereditor.core.pdf.renderer
...
/**
 * Thread-safe pool managing multiple PdfRenderer instances for concurrent page rendering.
 * Concurrency is strictly bounded via Semaphore(4) to protect memory and native resources.
 */
@Singleton
